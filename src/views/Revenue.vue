<template>
  <div class="section">
    ...
    <nav-bar title="Revenue"></nav-bar>

    <info-carousel v-if="revenueData != null">
      <slide>
        <info-tile title="Current Balance" prefix="" :text="currentBalance" />
      </slide>
      <slide>
        <info-tile title="Net Revenue" :text="netRevenue.toFixed(2)" color="#17a2b8" />
      </slide>
      <slide>
        <info-tile title="Total Payout" :text="totalPayout.toFixed(2)" color="#EE2B4B" />
      </slide>
      <slide>
        <info-tile title="Total Commission" :text="totalCommission.toFixed(2)" />
      </slide>
      <slide>
        <info-tile title="Average Revenue" :text="averageRevenue.toFixed(2)" color="#17a2b8" />
      </slide>
      <slide>
        <info-tile title="Total Months" prefix="" :text="totalMonths" color="#EE2B4B" />
      </slide>
    </info-carousel>

    <canvas class="mt-3" id="revenueChart" height="320"></canvas>
