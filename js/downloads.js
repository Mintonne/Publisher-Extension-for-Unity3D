...
$("#downloads-month-picker").datepicker({
    startView: 1,
    minViewMode: 1,
    maxViewMode: 2,
    format: "yyyymm",
...
function SetupDownloadsPackages(pos) {
    ...
    downloadsData.aaData.forEach((item) => {
        ...
        downloadsPackageCards.insertAdjacentHTML("beforeend", `<div class="download-package col-sm-4"><div class="card"><div class="card-body p-2"><p class="card-title text-dark">${PackageName}</p><h4 class="card-text text-primary">${Value}</h4></div></div></div>`);
    });
